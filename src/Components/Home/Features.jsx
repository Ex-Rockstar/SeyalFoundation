...
const Features = () => {
  return (
    <div className="flex items-center justify-center min-h-screen p-4 bg-gray-100">
      <div className="flex flex-col lg:flex-row w-full max-w-full overflow-hidden bg-white rounded-lg shadow-lg">
        {/* Left Side: Image */}
        <div className="flex-shrink-0 w-full lg:w-1/2">
          <img src={img9} alt="Design" className="object-cover w-full h-64 lg:h-full p-2" />
        </div>

        {/* Right Side: Text Content */}
        <div className="w-full lg:w-1/2 p-4 lg:p-8">
          <h2 className="mt-6 mb-4 text-lg font-medium text-[#8b4513] tracking-widest">OUR VISION</h2>
          ...
          <h2 className="mt-6 mb-4 text-lg font-medium text-[#8b4513] tracking-widest">OUR MISSION</h2>
          <p className="mb-6 text-gray-700">
